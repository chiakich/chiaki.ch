const tokens = {
  ...
  "sizes.section": {
    "value": "1080px",
    "variable": "var(--sizes-section)"
  },
  "sizes.width.section": {
    "value": "1080px",
    "variable": "var(--sizes-width-section)"
  },
  "sizes.container.xl": {
    "value": "1280px",
  ...
  "fonts.body": {
    "value": "\"xingothic-tc\", \"Noto Sans TC\", sans-serif",
    "variable": "var(--fonts-body)"
  },
  "fonts.akitra": {
    "value": "akitra, \"xingothic-tc\", sans-serif",
    "variable": "var(--fonts-akitra)"
  },
  "fonts.nixie": {
    "value": "nixie, monospace",
    "variable": "var(--fonts-nixie)"
  },
  "fonts.huninn": {
