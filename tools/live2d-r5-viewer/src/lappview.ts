...
export class LAppView {
  ...
  public initializeSprite(): void {
    ...
    // The terminal page supplies its own background; the official sample's
    // decorative background and gear are intentionally not mounted here.
    imageName = '';
