// The three.js half of DepthScrollSection, split out so `three` and
// @react-three/fiber stay out of /story's first load. DepthScrollSection renders
// the CSS shell immediately and pulls this in client-side.
...
export default DepthScrollCanvas
