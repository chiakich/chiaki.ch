...
const SearchChatDemo = () => (
  <Box maxW="680px" mx="auto" backgroundColor="#172534" border="1px solid #2b4157" borderRadius="18px" overflow="hidden" boxShadow="0 32px 90px rgba(0,0,0,.45)">
    <HStack height="46px" px={5} backgroundColor="#203448"><Box width="10px" height="10px" backgroundColor="#57b5ff" borderRadius="full" /><Text fontWeight="bold">圖片ㄉ撿改</Text><Text ml="auto" fontSize="xs" color="#8ea8bf">online</Text></HStack>
