...
const works: WorkCardData[] = [
  { id: 'chiakey', title: '千秋輸入法', en: 'CHIAKEY', description: '以 Yahoo! 奇摩輸入法／KeyKey 的開源程式碼為基礎的 macOS 注音輸入法，保留原本的組字手感與候選窗，在現代系統上繼續維護。', tags: ['macOS', '輸入法', '開源復興'], href: '/works/chiakey', accent: '#62a8ff', specimen: <ChiaKeySpecimen /> },
