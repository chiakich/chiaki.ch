...
const ChiaKeyFeatures = () => (
  <Stack gap={2}>
    ...
    <Grid columns={{ base: 1, md: 2 }} gap={5}>
      ...
      <FeatureScene title="Tab 斷詞" description="組字中把游標移到想斷開的位置按 Tab，就在那裡強制斷詞——「查相干純」在相干之間按一下，整句重組成「茶香甘醇」。"><SegmentationScene /></FeatureScene>
      <FeatureScene title="老朋友都還在" description="預設是好打注音的智慧組字，但傳統注音、倉頡、簡易這些 OpenVanilla 時代的輸入模組也一併保留。"><EnginesScene /></FeatureScene>
    </Grid>
  </Stack>
)
