...
const audiences = ['懷念 Yahoo! 奇摩輸入法候選窗與節奏', '想保存或研究 KeyKey／OpenVanilla 引擎', '偏好保守、小步維護的復興專案']

const ChiaKeyLinks = () => (
  <MotionSection>
    <SectionHeading en="DOWNLOAD" accent="#78b7ff">讓熟悉的輸入方式回來</SectionHeading>
    <Grid columns={{ base: 1, md: 2 }} gap={8}>
      <Stack gap={5}>
        <Text lineHeight="1.9" opacity={.8}>下載 macOS 安裝包後，到「系統設定 → 鍵盤 → 文字輸入」加入千秋輸入法。專案目前以支援 Apple Silicon 的現代 Xcode 維護。</Text>
        <HStack gap={3} flexWrap="wrap"><ProjectLink href="https://github.com/chiakich/ChiaKey/releases/latest" label="下載安裝包" detail=".pkg" accent="#78b7ff" /><ProjectLink href="https://github.com/chiakich/ChiaKey-Lexicon" label="詞庫專案" accent="#b8d9ff" /></HStack>
