...
const LearningScene = () => {
  ...
  <svg viewBox="0 0 640 300" width="100%" role="img" aria-label={t('chiakeyPage.scenes.learning.ariaLabel')}>
    ...
    <m.g animate={{ opacity: [0, 0, 1, 1], x: [-8, -8, 0, 0] }} transition={{ duration: 6, repeat: Infinity, times: [0, .4, .55, 1] }}>
    ...
    <m.g animate={{ opacity: [0, 0, 1, 1], y: [8, 8, 0, 0] }} transition={{ duration: 6, repeat: Infinity, times: [0, .45, .6, 1] }}>
