...
如果我想復刻一套字以鉛字的形式印到紙上的感覺，有辦法做到嗎？

第一個要想辦法的是變化。字型是一組固定的輪廓，每一個「書」字打出來都長得一模一樣。但活版的鉛字是一顆顆排上去的，即便是同一批印刷稿、同一個字，都會因為沾墨狀態和壓印力道不同，產生不一樣的墨漬形狀。字型能把其中一次的樣子凍結下來，卻沒辦法讓它每一次都不同（其實還是有辦法，只是變成一個字要做很多份）。
